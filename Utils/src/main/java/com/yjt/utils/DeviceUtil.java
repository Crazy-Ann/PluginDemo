...
public class DeviceUtil {
    ...
    public String getDeviceInfo(Context ctx, boolean isEncrypt) {
        try {
            ...
            builder.append("VERSION.RELEASE:[" + android.os.Build.VERSION.RELEASE);
            builder.append("] VERSION.CODENAME:[" + android.os.Build.VERSION.CODENAME);
            builder.append("] VERSION.INCREMENTAL:[" + android.os.Build.VERSION.INCREMENTAL);
            builder.append("] BOARD:[" + android.os.Build.BOARD);
            builder.append("] DEVICE:[" + android.os.Build.DEVICE);
            builder.append("] DISPLAY:[" + android.os.Build.DISPLAY);
            builder.append("] FINGERPRINT:[" + android.os.Build.FINGERPRINT);
            builder.append("] HOST:[" + android.os.Build.HOST);
            builder.append("] MANUFACTURER:[" + android.os.Build.MANUFACTURER);
            builder.append("] MODEL:[" + android.os.Build.MODEL);
            builder.append("] PRODUCT:[" + android.os.Build.PRODUCT);
            builder.append("] TAGS:[" + android.os.Build.TAGS);
            builder.append("] TYPE:[" + android.os.Build.TYPE);
            builder.append("] USER:[" + android.os.Build.USER + "]");
            if (isEncrypt) {
                return SecurityUtil.getInstance().encrypt3Des(builder.toString(), Constant.Data.KEY, Constant.Data.FROMAT);
            } else {
