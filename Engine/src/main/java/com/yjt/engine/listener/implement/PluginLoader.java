...
import com.yjt.engine.base.PluginApplication;
...
public class PluginLoader implements PluginLoadListener {
    ...
    public PluginBaseInfo load(PluginListener pluginListener, PluginBaseInfo pluginBaseInfo) throws PluginInstallException, PluginLoadException {
        ...
        try {
            ...
            LogUtil.getInstance().println("dependencies = " + pluginBaseInfo.getPluginApk().dependencies);
            LogUtil.getInstance().println("ignoreDependencies = " + pluginBaseInfo.getPluginApk().ignoreDependencies);
